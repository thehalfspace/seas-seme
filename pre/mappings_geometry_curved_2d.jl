##########################################################################
## This entire script is directly borrowed from Trixi.jl package
## Computes the node coordinates, jacobians, and normal directions for 
## straight sided unstructered quad mesh 
##########################################################################
...
function transfinite_quad_map(xi, eta, surface_curves::AbstractVector{<:Trixi.CurvedSurface})
...
function transfinite_quad_map_metrics(xi, eta, surface_curves::AbstractVector{<:Trixi.CurvedSurface})
...
function calc_curved_node_coordinates!(node_coordinates, element, nodes,
								surface_curves::AbstractVector{<:Trixi.CurvedSurface})
...
function calc_curved_metric_terms!(jacobian_matrix, element, nodes,
							surface_curves::AbstractVector{<:Trixi.CurvedSurface})
...
function calc_curved_normal_directions!(normal_directions, element, nodes,
									surface_curves::AbstractVector{<:Trixi.CurvedSurface})
